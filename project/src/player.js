...
(function (G) {
  ...
  async function loadFonts() {
    const specs = ['900 40px "Playfair Display"', 'italic 900 40px "Playfair Display"', '700 40px "Playfair Display"', '400 40px Anton', '500 40px Inter', '700 40px Inter', '800 40px Inter', '700 40px Caveat', '700 40px "Courier Prime"'];
