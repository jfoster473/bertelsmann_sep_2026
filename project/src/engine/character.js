...
(function (G) {
  ...
  const C = {
    ...
    hoodie: '#2F6F69', hoodieDark: '#265C57', string: '#EFE7D6',
    pants: '#2F3B57', pantsDark: '#27324B',
    shoe: '#F1EBDF', sole: '#CFC4B0', stripe: '#C8483C',
  ...
  // ---- crowd figures --------------------------------------------------------------
  const SHIRTS = ['#C8483C', '#5B8DB8', '#DDB654', '#2F6F69', '#E59C8C', '#F1EBDF', '#3A3633', '#8FB08A', '#7A5BA0', '#E07A3F'];
  ...
  E.crowdSprite = function (i) {
    ...
    return E.makeCutout('crowd' + v, 44, 84, (ctx) => {
      ...
      const pants = r() < 0.5 ? '#2F3B57' : r() < 0.5 ? '#4A4038' : '#5E6E86';
      // legs
      ctx.fillStyle = pants;
