# Fact sheet – every figure used on screen (gen now version)

> Copied from the original version (`../../../docs/facts.md`); the figures are unchanged. The only new claim is **Y5** (the gen now logo card on the last slide), added below.
...
| Y5 | Logo card „unterstützt von gen now · Ein Projekt der Bertelsmann Stiftung" (replaces Y3's strip in this version) | gennow.de/wirtschaft/young-founders-network/ (read 26.09.2026): page „Zusammenarbeit mit dem Young Founders Network", „Das YFN unterstützen wir als beeindruckendes Peer-to-Peer Netzwerk …"; the YFN is called „Unser Kooperationspartner" on the same site. gennow.de home page: „Ein Projekt der Bertelsmann Stiftung", „Wir sind GenNow, eine Initiative der Bertelsmann Stiftung" | ✅ |
