/* =============================================================================
   ...
   gen now version: same story, timings and figures as the original
   (../../../../project/), restyled in the gen now brand (see docs/brand.md).
   ...
   Item fields:
     ...
     type    'strip' (torn paper label) | 'caption' (charcoal bar, lower third)
             ...
             | 'logocard' (white card with the gen now + Bertelsmann Stiftung logos)
     text    on-screen text; '\n' = line break
     ...
     color   gen now palette: white | cream | ink | blue | sky | yellow | yellowLite | pink
             | green | lilac | purple | lined   (see engine/paper.js)
...
(function (G) {
  ...
  const TL = {
    ...
    scenes: [
      ...
      { id: 'study', start: 7, end: 13, bg: 'sky', transition: { type: 'sheet', from: 'right', dur: 0.6 } },
      { id: 'crowd', start: 13, end: 23.5, bg: 'yellow', transition: { type: 'sheet', from: 'top', dur: 0.6 } },
      { id: 'barriers', start: 23.5, end: 34, bg: 'pink', transition: { type: 'sheet', from: 'left', dur: 0.6 } },
      { id: 'good', start: 34, end: 42, bg: 'green', transition: { type: 'sheet', from: 'right', dur: 0.6 } },
      { id: 'gem', start: 42, end: 48, bg: 'lilac', transition: { type: 'sheet', from: 'bottom', dur: 0.6 } },
      { id: 'end', start: 48, end: 54, bg: 'blue', transition: { type: 'sheet', from: 'top', dur: 0.65 } },
    ],

    // ------------------------------------------------------------------ items --
    items: [
      // ===== 1 HOOK ===========================================================
      { id: 'd1', scene: 'hook', type: 'strip', text: 'Zu unsicher!', font: 'shout', size: 56, color: 'blue', x: 285, y: 630, rot: -5, in: 1.08, out: 7.6, enter: 'drop' },
      ...
      { id: 'money', scene: 'hook', type: 'strip', text: 'Dafür brauchst\ndu viel Geld!', font: 'typed', size: 36, color: 'yellow', x: 765, y: 850, rot: -3, in: 2.96, out: 34.27, enter: 'drop', exit: 'fly', top: true,
      ...
      { id: 'd5', scene: 'hook', type: 'strip', text: 'Das machen\ndoch nur andere.', font: 'serifSmall', size: 42, color: 'sky', x: 262, y: 1235, rot: -2, in: 3.76, out: 7.6, enter: 'drop' },
      { id: 'h1', scene: 'hook', type: 'strip', text: 'Eigene Firma gründen?', font: 'headline', size: 78, color: 'white', x: 80, anchor: 'left', y: 350, rot: -2, in: 0.55, out: 7.6, enter: 'drop' },
      { id: 'h2', scene: 'hook', type: 'strip', text: 'Ich doch nicht …', font: 'headlineItalic', size: 70, color: 'blue', x: 130, anchor: 'left', y: 465, rot: 1.5, in: 4.56, out: 7.6, enter: 'drop' },
      { id: 'c1', scene: 'hook', type: 'caption', text: 'Kommt dir bekannt vor?', in: 5.1, out: 7.6 },

      // ===== 2 STUDY ==========================================================
      { id: 's_k', scene: 'study', type: 'strip', text: 'Neue Studie · Bertelsmann Stiftung', font: 'kicker', color: 'ink', x: 80, anchor: 'left', y: 330, rot: -1, in: 7.4, out: 13.63, enter: 'slideL' },
      ...
      { id: 's_h2', scene: 'study', type: 'strip', text: '14- bis 25-Jährige', font: 'headline', color: 'yellow', x: 100, anchor: 'left', y: 548, rot: 1, in: 8.56, out: 13.63, enter: 'drop' },
      ...
      { id: 's_n2', scene: 'study', type: 'strip', text: 'online befragt · Frühjahr 2026', font: 'typed', size: 31, color: 'yellowLite', x: 100, anchor: 'left', y: 842, rot: -1.2, in: 10.44, out: 13.6, enter: 'slideL' },
      { id: 's_stamp', scene: 'study', type: 'stamp', text: 'REPRÄSENTATIV', ink: '#0C55A6', size: 44, x: 705, y: 1175, rot: -9, in: 11.17, out: 12.55 },
      ...
      { id: 'q_big', scene: 'crowd', type: 'strip', text: 'Fast 4 von 10', font: 'shout', size: 104, color: 'blue', x: 80, anchor: 'left', y: 350, rot: -2, in: 18.62, out: 24.1, enter: 'drop' },
      ...
      { id: 'b_base', scene: 'barriers', type: 'strip', text: 'Befragte, die sich Gründen nicht vorstellen können', font: 'small', size: 30, color: 'ink', x: 90, anchor: 'left', y: 412, rot: 0.8, in: 24.88, out: 34.64, enter: 'slideL' },
      { id: 'b_multi', scene: 'barriers', type: 'hand', text: 'Mehrfachnennungen möglich', size: 46, color: '#0C3F7A', x: 520, y: 1030, rot: -3, in: 29.63, out: 34.64 },
      { id: 'b_tw', scene: 'barriers', type: 'strip', text: 'Und Geld? Kaum ein Problem.', font: 'headline', size: 64, color: 'green', x: 70, anchor: 'left', y: 1112, rot: -1.5, in: 30.12, out: 34.64, enter: 'drop' },
      { id: 'b_stamp', scene: 'barriers', type: 'stamp', text: 'UNTER 10 %', ink: '#0C55A6', size: 52, x: 718, y: 1302, rot: -7, in: 30.72, out: 34.27, exit: 'fly', top: true },
      { id: 'c4', scene: 'barriers', type: 'caption', text: 'Startkapital nennt nicht mal\njede:r Zehnte.', in: 31.1, out: 34.6 },

      // ===== 5 GOOD NEWS ======================================================
      { id: 'g_h', scene: 'good', type: 'strip', text: 'Die gute Nachricht:', font: 'headlineItalic', size: 76, color: 'yellow', x: 80, anchor: 'left', y: 335, rot: -1.5, in: 34.4, out: 42.65, enter: 'drop' },
      ...
      { id: 'g_a_st', scene: 'good', type: 'stamp', text: 'LÖSBAR', ink: '#0C55A6', size: 46, x: 790, y: 590, rot: 9, in: 35.77, out: 42.65 },
      ...
      { id: 'g_b_st', scene: 'good', type: 'stamp', text: 'LÖSBAR', ink: '#0C55A6', size: 46, x: 790, y: 955, rot: -7, in: 38.38, out: 42.65 },
      ...
      { id: 'm_sub', scene: 'gem', type: 'strip', text: 'Anteil der 18- bis 24-Jährigen, die gerade\ngründen oder kürzlich gegründet haben', font: 'small', size: 29, color: 'ink', x: 90, anchor: 'left', y: 435, rot: 0.6, in: 42.91, out: 48.56, enter: 'slideL', align: 'left' },
      ...
      // ===== 7 END ============================================================
      { id: 'e_k', scene: 'end', type: 'strip', text: 'Dein nächster Schritt:', font: 'headlineItalic', size: 66, color: 'yellow', x: 80, anchor: 'left', y: 330, rot: -2, in: 48.4, out: 99, enter: 'drop' },
      { id: 'e_t', scene: 'end', type: 'strip', text: 'Young Founders\nNetwork', font: 'headline', size: 96, color: 'white', x: 80, anchor: 'left', y: 520, rot: 1, in: 48.8, out: 99, enter: 'drop' },
      { id: 'e_s', scene: 'end', type: 'strip', text: 'Community für junge Gründer:innen unter 25', font: 'body', size: 36, color: 'cream', x: 90, anchor: 'left', y: 700, rot: -1, in: 49.2, out: 99, enter: 'slideL' },
      // gen now: the Bertelsmann line became a logo card ("unterstützt von gen now – Ein Projekt der Bertelsmann Stiftung");
      // gennow.de/wirtschaft/young-founders-network: „Das YFN unterstützen wir …" (see docs/brand.md)
      { id: 'e_b', scene: 'end', type: 'logocard', text: 'unterstützt von gen now · Ein Projekt der Bertelsmann Stiftung', lead: 'unterstützt von', x: 712, y: 1285, rot: 2.5, in: 49.86, out: 99, enter: 'drop' },
      { id: 'e_url', scene: 'end', type: 'strip', text: 'youngfounders.network', font: 'headline', size: 76, color: 'yellow', x: 520, y: 865, rot: -2.5, in: 50.35, out: 99, enter: 'drop', tape: true },
      { id: 'e_hand', scene: 'end', type: 'hand', text: 'schau vorbei!', size: 62, color: '#FCDF48', x: 700, y: 1062, rot: -6, in: 50.75, out: 99, arrow: { x0: 705, y0: 1012, x1: 645, y1: 935, bend: -0.3 } },
    ...
    crowd: {
      ...
      groups: [
        ...
        { value: 9, n: 9, label: 'haben es fest vor', color: 'blue', text: '9 %' },
        { value: 28, n: 28, label: 'vorstellbar, aber noch unsicher', color: 'pink', text: '28 %' },
        ...
        { value: 3, n: 3, label: 'haben’s schon gemacht', color: 'ink', text: '3 %' },
      ],
    },
    barriers: {
      rows: [
        // value: bar length in %; text: what is printed (see docs/facts.md F8 for "rund 60 %")
        { value: 60, text: 'rund 60 %', label: 'zu unsicher – lieber angestellt', icon: 'lock', color: '#0C55A6', in: 26.19 },
        { value: 48, text: '48 %', label: 'zu wenig Wissen übers Gründen', icon: 'question', color: '#1EB4FF', in: 27.34, carry: 'g_a' },
        { value: 39, text: '39 %', label: 'Angst vor zu viel Stress', icon: 'bolt', color: '#FCDF48', in: 28.49, carry: 'g_b' },
      ],
    ...
    gem: {
      ...
      bars: [
        { year: '2024', value: 12.9, text: 'knapp 13 %', in: 44.03, color: '#8FD6FF' },
        { year: '2025', value: 23.2, text: 'über 23 %', in: 44.43, color: '#0C55A6' },
      ],
      arrowAt: 45.13,
    },
    ...
    // ------------------------------------------------------ gen now brand --
    // corner logo (top-left, in the strip above the key-text safe area); it
    // fades out as the last slide arrives, where the logo card takes over.
    brand: {
      watermark: { x: 70, y: 200, h: 62, in: 0.45, out: 48.3 },
    },
